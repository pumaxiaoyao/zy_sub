...
class SscOrderController extends BaseController
{
    protected function _initialize()
    {
        ...
        $this->userTrad = SscUser::getByUser($this->user->tokenint);
    }
    ...
    public function save(Request $request)
    {
        ...
        if ($res) {
            ...
            // 转盘
            if (!empty($tradList)) {
                $trad                 = SscUser::getByUser($this->user->tokenint);
    ...
    public function summary(Request $request)
    {
        ...
        $url  = $request->baseUrl();
        $data = paginate_data($page, $per_page, $params, $where, $list, $url, SscOrder::class, 'summary');
